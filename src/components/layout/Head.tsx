...
export function Head(props: Props) {
  return (
    <NextHead>
      ...
      <meta property="og:url" content="https://airdrop-machine.netlify.app/" />
      ...
      <meta property="og:image" content={'https://bafybeiaanz35rifxfwu43cc3mdzbuevas3mflm77htcrmprwy3fdwhmgji.ipfs.w3s.link/parachute.jpg'} />
